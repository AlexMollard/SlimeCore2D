...
public:
	...
	GameObject* CreateQuad(glm::vec2 pos, glm::vec2 size = glm::vec2(1), glm::vec3 color = glm::vec3(1));
	...
	Player* CreatePlayer(glm::vec2 pos, glm::vec2 size = glm::vec2(1), glm::vec3 color = glm::vec3(1));
